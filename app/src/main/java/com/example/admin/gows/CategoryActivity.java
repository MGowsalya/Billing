...
//            Fragment scheduleFragment = new Reports();
//            fragmentTransaction.replace(R.id.container, scheduleFragment);//"CategoryActivity");
//            fragmentTransaction.addToBackStack("Reports");
//            fragmentTransaction.commit();
          switch (position)
          {
              case 0:
                  Cat_add ca = new Cat_add();
                  return ca;

              case 1:
                  Cat_edit ce = new Cat_edit();
                  return ce;
              }
          return null;
            }
